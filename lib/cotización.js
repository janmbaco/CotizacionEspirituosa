...
var global = require("./global")
    ...
    , cotización = module.exports = (function() {
        ...
        return {
            IniciarSesión: function(Id_TPV, Fecha, ArrayIdGruposBebida, EvResultado) {
                ...
                db.Sesiones.ObtenerNuevoId(function(id) {
                    ...
                    cmdSQL[cmdSQL.length] = "UPDATE TPV SET Id_Sesion = "+id+", Fecha"
                    //Eliminar la cotización anterior
                    cmdSQL[cmdSQL.length] = "DELETE FROM Cotizacion;";
                    cmdSQL[cmdSQL.length] = "DELETE FROM Acciones;"; 
                    cmdSQL[cmdSQL.length] = "DELETE FROM Acciones_TPV;"; 
