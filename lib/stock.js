    ...
    , stock = module.exports = (function() {
        ...
        return {
            ...
            , ModificarGrupoBebida: function(idGrupoBebida, Orden, Nombre, TipoGenerico, Color, EvResultado) {
                var cmdSQL = ["UPDATE " + db.Tablas[global.Grupos_Bebida].Tabla + " SET Orden = (SELECT Orden FROM Grupos_Bebida WHERE Id_G_Bebida = "+idGrupoBebida+") WHERE Orden = "+Orden+";"
                    , "UPDATE " + db.Tablas[global.Grupos_Bebida].Tabla + " SET Orden = " + Orden + ", Nombre='" + Nombre + "', Tipos_Genericos = " + TipoGenerico + ", Color = " + Color + " WHERE Id_G_Bebida = " + idGrupoBebida + ";"];
                
                db.EjecutarSQL(cmdSQL
                    , EvResultado
                    );
            }
