...
var global = require("./global")
    ...
    , stock = module.exports = (function() {
        ...
        return {
            ...
            , Bebidas: (function() {
                return {
                    ListarTiposServicio: function(idGrupoBebida, idBebida, bTiposGenericos, EvResultado) {
                        ...
                        db.EjecutarSQL("SELECT Id_T_Servicio, Nombre, Cantidad, Color FROM Tipos_Servicio;"
                            , function(bExito, arrTiposServicio) {
                                ...
                                var sec = 0;
                                var CargaRecursiva = function(bExito) {
                                    if (!bExito) {
                                        if (!global.isUndefined(EvResultado))
                                            EvResultado(bExito, oBebidasTipoServicio);
                                        return;
                                    }
                                    ...
                                    db.EjecutarSQL("SELECT Precio, Maximo, Minimo, Tramo \n\
                                                    FROM Precios \n\
                                        ...
                                        , function(bExito, rowsArray) {
                                            ...
                                            if (rowsArray.length === 0) {
                                                ...
                                                db.EjecutarSQL("SELECT Precio, Maximo, Minimo, Tramo \n\
                                                    ...
                                                    , function(bExito, rowsArray2) {
                                                        ...
                                                        if (parseFloat(rowsArray2[0][0]) === parseFloat(rowsArray2[0][1]) && parseFloat(rowsArray2[0][0]) === parseFloat(rowsArray2[0][2])) {
                                                            ...
                                                            db.EjecutarSQL("INSERT INTO Cotizacion VALUES(" + idBebida + "," + arrTiposServicio[sec][0] + "," + rowsArray2[0][0] + ", 0);"
                                                                , function(b, r) {
                                                ...
                                                if (parseFloat(rowsArray[0][0]) === parseFloat(rowsArray[0][1]) && parseFloat(rowsArray[0][0]) === parseFloat(rowsArray[0][2])) {
                                                    ...
                                                    db.EjecutarSQL("INSERT INTO Cotizacion VALUES(" + idBebida + "," + arrTiposServicio[sec][0] + "," + rowsArray[0][0] + ", 0);"
                                                        , function(b, r) {
                                                            TiposServicioxBebida[i][8] = 1;
                                                            sec++;
                                                            CargaRecursiva(true);
                    ...
                    , CalcularRelacionInicial: function(idGrupoBebida, idBebida, EvResultado) {
                        db.EjecutarSQL("SELECT CAST(BS.Cantidad_Stock AS REAL) /  CAST(T.Cantidad_Total AS REAL) \n\
                                JOIN Bebidas_Sesiones  \n\
                                JOIN Grupos_Bebida_Sesiones GBS ON GBS.Id_G_Bebida = " + idGrupoBebida + " AND BS.Id_Sesion = GBS.Id_Sesion \n\
                                JOIN (SELECT SUM(BS.Cantidad_Stock) Cantidad_Total, Id_G_Bebida, Id_Sesion \n\
                                            FROM Bebidas_Sesiones BS \n\
                                            JOIN Bebidas B ON BS.Id_Bebida = B.Id_Bebida\n\
                                            GROUP BY Id_G_Bebida) T ON T.Id_G_Bebida = B.Id_G_Bebida AND T.Id_Sesion = GBS.Id_Sesion\n\
                                WHERE  BS.Id_Bebida = " + idBebida + " AND GBS.Id_Sesion = (SELECT Id_Sesion FROM Sesiones WHERE Fin IS NULL)\n\
                    ...
                    , Modificar: function(idBebida, Nombre, CantidadxBotella, EvResultado) {
                        db.EjecutarSQL("UPDATE " + db.Tablas[global.Bebidas].Tabla + " SET Nombre = '" + Nombre + "', Cantidad_Botella = " + global.str_o_null(CantidadxBotella) + " WHERE Id_Bebida = " + idBebida + ";"
                            , EvResultado);
                    }
            ...
            , ListarBebidas: function(EvObtResultados) {
                db.EjecutarSQL("SELECT B.Id_Bebida, B.Nombre, B.Id_G_Bebida, G.Nombre NombreGrupoBebida, CAST(BS.Cantidad_Stock AS REAL) /  CAST(T.Cantidad_Total AS REAL), Z.Cantidad_Bebidas, G.Tipos_Genericos, G.Color \n\
                                ...
                                JOIN Grupos_Bebida_Sesiones GBS ON B.Id_G_Bebida = GBS.Id_G_Bebida AND BS.Id_Sesion = GBS.Id_Sesion \n\
                                ...
                                WHERE GBS.Id_Sesion = (SELECT Id_Sesion FROM Sesiones WHERE Fin IS NULL)\n\
